...
// не распахнуто на весь экран
    ...
    public MainFrame() {
        ...
        Action charismaAction = new AbstractAction("Включить Харизму") {
            public void actionPerformed(ActionEvent event) {
                field.setCharismaEnabled(!field.isCharismaEnabled());
                charismaMenuItem.setText(field.isCharismaEnabled() ? "Выключить Харизму" : "Включить Харизму");
            }
        };
